...
\newglossaryentry{intsn}{
  type=symbols,
  name={\ensuremath{[n]}},
  description={Shorthand notation for the set of natural numbers up to and including $n$: \ie{} $\qty{0, 1, \ldots, n}$} % TODO include 0?
}
...
\newglossaryentry{binF}{
  type=symbols,
  name={\ensuremath{\F_2}},
  description={The finite field with two elements: $\qty{0, 1}$}
}
\printglossaries
