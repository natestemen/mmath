...
Introduced in context of quantum computation by \citeauthor{fault-tolerance}, the idea of fault tolerance is make quantum computers that can perform meaningful computation despite decoherence and other errors~\cite{fault-tolerance}.
