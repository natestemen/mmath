...
Indeed as an interesting historical note, once \ac{ISA} had become commonplace, chip designers began to implement more and more complex instructions so programmers could use them natively.
