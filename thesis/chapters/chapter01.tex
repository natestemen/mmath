...
\begin{itemize}
    ...
    \item\texttt{aux/} is where all the stuff goes that
    surrounds the ``real'' content, such as the acknowledgments,
    dedication, etc.
    \item\texttt{img/} is where you put all the graphics you use in
    the thesis. Maybe they should be organized into subfolders
    depending on the chapter they are used in, if you have a lot of
    graphics.
    \item\texttt{bib.bib}: the Bib\TeX\ database to organize
    ...
    \item\texttt{config.tex}: a central place to load all
...
In order to make things easier, \texttt{config.tex}
...
the data in the following lines of \texttt{config.tex:}%
...
Further customization can be made in \texttt{config.tex}
...
Many other customizations in \texttt{config.tex} are
